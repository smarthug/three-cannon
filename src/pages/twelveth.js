...
//   function rainbowGradient(t) {
//       var c = {r:0,g:0,b:0};
//     //  var c = 1.0 - pow(abs(vec3(t) - vec3(0.65, 0.5, 0.2)) * vec3(3.0, 3.0, 5.0), vec3(1.5, 1.3, 1.7));
//     c.r = 1.0 - Math.pow(Math.abs(t - 0.65) * 3.0, 1.5)
//     c.g = 1.0 - Math.pow(Math.abs(t - 0.5) *  3.0,  1.3);
//     c.b = 1.0 - Math.pow(Math.abs(t - 0.2) * 5.0, 1.7);

//     // c.r = Math.max((0.15 - square(abs(t - 0.04) * 5.0)), c.r);
//     c.r = Math.max((0.15 -Math.pow(Math.abs(t - 0.04) * 5.0),2), c.r);
//     c.g = (t < 0.5) ? smoothstep(0.04, 0.45, t) : c.g;
//     // return clampNumber(c, 0.0, 1.0); 
//     // c.r = clampNumber(c.r, 0.0, 1.0)
//     // c.g = clampNumber(c.g, 0.0, 1.0)
//     // c.b = clampNumber(c.b, 0.0, 1.0)
//     return c; 
//   }
